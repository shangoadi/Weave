...
package weave.visualization.layers
{
	...
	public class PlotLayer extends UIComponent implements IPlotLayer, IDisposableObject
	{
		...
		public function get plotFilters():Array      			 { return aggregateBitmap.filters;        }
		
		// value can be null for no style
		// Array is of type BitmapFilter
		public function set plotFilters(value:Array):void        { aggregateBitmap.filters = value;       }
		...
		*/
		...
		public function getSelectedKeys():Array
		{
			...
			{
				keys = _spatialIndex.getKeysBoundingBoxOverlap(_dataBounds);
